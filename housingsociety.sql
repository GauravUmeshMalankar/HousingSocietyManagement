...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2025 at 07:45 PM
...
(25, 25, 'Sahil Mestri', '9876543210', '890123456789', 'Member', '2025-03-01', '2025-03-31');
...
INSERT INTO `events` (`id`, `event_title`, `event_date`, `event_time`, `event_description`, `created_at`) VALUES
(1, 'Holi Celebration', '2025-03-25', '10:00:00', 'Celebrate the festival of colors with music, dance, and sweets!', '2025-03-13 12:41:12'),
(2, 'Diwali Celebration', '2025-11-05', '19:30:00', 'Join us for an evening filled with festivities, music, and sweets!', '2025-03-13 12:41:12'),
(3, 'Sports Day', '2025-06-20', '08:00:00', 'A day full of fun sports activities and competitions for all age groups.', '2025-03-13 12:41:12'),
(4, 'Blood Donation Camp', '2025-07-15', '09:00:00', 'Organized in collaboration with Red Cross. Save lives by donating blood.', '2025-03-13 12:41:12'),
(5, 'Christmas Eve Party', '2025-12-24', '20:00:00', 'Enjoy a fun-filled evening with carols, gifts, and a surprise Santa visit!', '2025-03-13 12:41:12'),
(6, 'Monsoon Plantation Drive', '2025-08-01', '10:00:00', 'Let’s make our society greener! Participate in the tree plantation drive.', '2025-03-13 12:41:12'),
(7, 'Navratri Dandiya Night', '2025-10-02', '19:00:00', 'Dress up in traditional attire and enjoy an energetic Dandiya night!', '2025-03-13 12:41:12'),
(8, 'Mahashivratri Celebration', '2025-02-26', '18:30:00', 'Join us for an evening of devotional bhajans and prayers.', '2025-03-13 12:41:12'),
(9, 'Ram Navami Celebration', '2025-04-06', '17:00:00', 'A special event with religious discourses and prasad distribution.', '2025-03-13 12:41:12'),
(10, 'Wedding Celebration', '2025-05-15', '19:00:00', 'A grand wedding celebration in the society clubhouse!', '2025-03-13 12:41:12');
...
(11, 11, 'Kunal Deshmukh', 500.00, 'water Damage');
...
(25, 'Sahil Mestri', '890123456789', '701', '9876543210', 'Sahil@gmail.com', 1200.00, 'REG025', '2025-03-14', 'Manager');
...
(12, '2025-03-25', '2025-03-14', 'Palav Narayan', 'Parking Space Allocation', 'uploads/agenda_february.jpg');
...
INSERT INTO `users` (`id`, `user_type`, `username`, `email`, `password`, `created_at`, `profile_image`) VALUES
(1, 'admin', 'admin', 'admin@gmail.com', '$2y$10$P5ArodD9Ggp7T9upRxrzAOOj87nQSrW8UwEOKRYnD7F8bWKgVo.0.', '2025-03-03 15:04:47', NULL),
(2, 'user', 'user1', 'user1@gmail.com', '$2y$10$ld5VNwoJ.kvktfK66wVQPeGeFXWlbjnvf9Z6jhqW4uDcrBZWjjFqm', '2025-03-03 15:45:11', NULL),
(3, 'admin', 'Admin1', 'admin1@gmail.com', '$2y$10$0DStSFForHlX.ulcgogmvu9wuCB.kvCBtG8NX9PT0c5nx7Es/X/4C', '2025-03-06 14:53:21', NULL),
(4, 'admin', 'Mob', 'mobpyscho438@gmail.com', '$2y$10$08JcSJ8/LISZ6trCt270COCWZLeVnuqI7l19c2N4jcdDJKlRT0Eia', '2025-03-08 11:22:23', NULL),
(5, 'admin', 'AdminUser', 'adminuser@gmail.com', '$2y$10$hNb38QuwJSB3QQKaJQEfiOzfnD1Ttfp1MiemWnJTrs3J28jN2icTG', '2025-03-15 09:14:34', NULL),
(6, 'admin', 'Sahil ', 'Sahil@gmail.com', '$2y$10$OhYTRUAv8OU96MjTh3iwU.iTaim9FbSqDQhap6J.OdYlbnndQYI8a', '2025-03-15 15:43:24', 'uploads/Profile1.png'),
(7, 'admin', 'Divyesh', 'divyesh23@gmail.com', '$2y$10$NzeB1UYgxEe9Uaac5yGqYOaJBf4dST8GKc.KV6PRI4s2llbNJuCf2', '2025-03-15 16:05:00', 'uploads/Profile2.png'),
(8, 'admin', 'Vinay ', 'vinaytambe@gmail.com', '$2y$10$DvBRvm07Bw2DGxj2SaU4Je41vhyeGS10JKb.gOV1fJNDhO1dBYhLu', '2025-03-15 16:06:20', 'uploads/Profile3.png'),
(9, 'admin', 'YashDavli', 'YashDavli@gmail.com', '$2y$10$fWiJELKfdvEHkf8jIlj/Du87C2gMIVKuZCTBcRmIwyhIGMLb.Mere', '2025-03-15 16:07:03', 'uploads/Profile4.png'),
(10, 'user', 'Gauresh', 'gauresh@gmail.com', '$2y$10$EQ/bsAgRhcKN56o8wDbWteXRPIRkr1c5cmlg.5aqFyMm6EKN9Ngly', '2025-03-15 16:07:34', 'uploads/Profile5.png'),
(11, 'user', 'Pratik', 'PratikVaderkar@gmail.com', '$2y$10$E8JGy/d0U2GxfV35dlleque.rdiqnPy0qEJrZvS.9E5JOar9mHdYu', '2025-03-15 16:08:35', 'uploads/Profile6.png');
