...
<div class="header-container">
  <header class="bg-red-800 text-white">
    <div class="container mx-auto flex justify-between items-center py-4 px-6">
      ...
      <div class="flex items-center space-x-4">
        ...
        <a class="hover-effect" href="#">Log In</a>
        <span>|</span>
        <a class="hover-effect" href="#">Sign Up</a>
      </div>
      </div>
    </div>
  </header>
  ...
  <nav class="bg-red-800 shadow">
    <div class="container mx-auto flex justify-between items-center py-4 px-6">
      <div class="flex items-center space-x-4">
        <span class="text-xl font-bold text-white">Housing.com</span>
      </div>
      <div class="hidden md:flex space-x-6">
        <a class="text-white font-bold hover-effect" href="home.php">HOME</a>
        <a class="text-white font-bold hover-effect" href="frmMemberMaster.php">MEMBER</a>
        <a class="text-white font-bold hover-effect" href="frmCommitteeMaster.php">COMMITTEE</a>
        <a class="text-white font-bold hover-effect" href="frmElectionDetails.php">ELECTION</a>
        <a class="text-white font-bold hover-effect" href="frmMaintenance.php">MAINTENANCE</a>
        <a class="text-white font-bold hover-effect" href="frmMonthlyMeeting.php">MEETING</a>
        <a class="text-white font-bold hover-effect" href="frmFine.php">FINE</a>
      </div>
      <div class="md:hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <div class="text-left">
        <div>
          ...
          <p class="mt-2">
            <img src="images/location.png" class="inline-block w-4 mr-2" alt="Location Icon" /> Address
          </p>
          <p class="mt-2">
      ...
      <div class="text-left">
       ...
       <div class="text-left">
        ...
        <p class="mt-2">
          There are many variations of passages of Lorem Ipsum available, but the industry...
        </p>
      </div>
